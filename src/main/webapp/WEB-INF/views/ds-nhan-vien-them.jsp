	...
	<div class="container">
		...
		<div class="title-2">
			<form:form method="POST" id="form" modelAttribute="formThem"
				action="${pageContext.request.contextPath}/nhanvienxacnhanthem">
				<div class="row">
					<!-- 					<div class="col-xs-6 form-group"> -->
					<!-- 						<label>Mã người dùng</label> <input class="form-control" -->
					<!-- 							name="maNql" type="text" /> -->
					<!-- 					</div> -->
					<div class="col-xs-6 form-group">
					...
					<div class="col-xs-6 form-group">
						<label>Phòng thực hành</label><select class="form-control"
							...
							<c:forEach var="danhsachpth" items="${danhsachpth}">
								<option value="${danhsachpth.maPth }">${danhsachpth.phongThucHanh} - ${danhsachpth.maPth}</option>
							</c:forEach>
						</select>
					</div>
					<div class="col-xs-6 form-group">
