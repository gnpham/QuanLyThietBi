...
<title>Thống kê thiết bị theo khoa</title>
</head>
<body>
	<div class="title-1">
		<h3>
			<b>Danh sách thiết bị khoa ${layMaKhoa.tenKhoa}</b><br />
		</h3>
	</div>
	<div class="form">
	...
	<form class="textsize">
		<div class="panel panel-default">
			<table class="table table-bordered">
				...
				<tbody>
					<c:forEach var="danhsachtbkhoa" items="${danhsachtbkhoa}"
						varStatus="stt">
						<tr>
							<%-- 									<td>${stt.index +1 }</td> --%>
							<td>${danhsachtbkhoa.tbPhieuXuat.tbNhanVien.tbPhongThucHanh.maPth }</td>
							<td>${danhsachtbkhoa.tbPhieuXuat.maPhieuXuat }</td>
							<td>${danhsachtbkhoa.tbPhieuXuat.ngayXuat }</td>
							<td>${danhsachtbkhoa.tbChiTietNhapXuat.tbDanhMucThietBi.maThietBi}</td>
							<td>${danhsachtbkhoa.tbChiTietNhapXuat.tenThietBi }</td>
							<td>${danhsachtbkhoa.tbChiTietNhapXuat.donViTinh }</td>
							<td>${danhsachtbkhoa.soLuongXuat}</td>
							...
							<td>${danhsachtbkhoa.tbChiTietNhapXuat.nguyenGia }</td>
							...
							<td>${danhsachtbkhoa.tbChiTietNhapXuat.maCode}</td>
							<td>${danhsachtbkhoa.tbPhieuXuat.tbNhanVien.hoTen}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
