	...
	<div class="container">
		...
		<div class="title-71">
			<form:form method="post" id="form" modelAttribute="formThem"
				action="${pageContext.request.contextPath}/themtb">
				<!-- 				 1 -->
				<div class='row'>
					<div class='col-sm-10'>
						<div class='form-group'>
							<label for="user_title">Phiếu nhập số (*)</label> <input
								...
								value="${maPhieuNhapThem.maPhieuNhap}" readonly="readonly"
								type="text" />
						</div>
					</div>
				</div>
				<div class='row'>
					...
					<!-- 								class="form-control" id="user_lastname" name="thietBiId" size="30" -->
					<!-- 								type="text" /> -->
					<!-- 						</div> -->
					<!-- 					</div> -->
					<div class='col-sm-5'>
					...
					<div class='col-sm-5' hidden>
						<div class='form-group'>
							<label for="user_title">Mã Code</label> <input
								placeholder="Mã code có dạng JP2017TB00001" class="form-control" readonly="readonly"
					...
					<div class='col-sm-10'>
						<div class='form-group'>
							<label for="user_title">Mô tả</label> <input class="form-control"
								placeholder="Thông số kỹ thuật thiết bị" id="user_title"
