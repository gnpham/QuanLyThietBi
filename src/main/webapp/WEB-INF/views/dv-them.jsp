	...
	<div class="container">
		...
		<div class="title-71">
			<form:form method="post" id="form" modelAttribute="formThem"
				action="${pageContext.request.contextPath}/danhsachdvthem">
				<div class='row'>
					<div class='col-sm-10'>
						<div class='form-group'>
							<label for="user_title">Tên khoa</label> <input
								class="form-control" id="user_title" name="tenKhoa" size="30"
								type="text" />
						</div>
					</div>
				</div>
				...
				<div>
					<div class="col-md-1 col-md-offset-8">
						<a class="btn btn-danger"
							href="${pageContext.request.contextPath}/danhsachdonvi"> Quay
							lại</a>
					</div>
