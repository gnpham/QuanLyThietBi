...
<body>
	...
	<div class="container">
		<div class="title-1">
			<h3>
				<b>THÔNG TIN CHI TIẾT PHIẾU NHẬP</b>
			</h3>
		</div>
		<div class="title-7">
			<div>
				<form:form method="POST" id="form" modelAttribute="formHienThi"
					...
					<div class="row">
						...
						<div class="col-xs-6 form-group">
							<label>Tổng giá trị:</label> ${layMaPhieuNhap.tongGiaTri }
						</div>
					</div>
				</form:form>
			</div>
			...
			<form class="textsize">
					...
					<table class="table table-bordered">
						<thead>
							<tr style="background-color: #F67011">
								...
								<th style="width: 90px">Nước SX</th>
								<!-- 						<th style="width: 100px">Mô tả</th> -->
								<th style="width: 80px">Khấu hao</th>
				...
				<div class="col-md-1 col-md-offset-10">
					<div class="input-group stylish-input-group">
						<a
							href="${pageContext.request.contextPath}/chuyennhapthietbi?id=${layMaPhieuNhap.maPhieuNhap}"
