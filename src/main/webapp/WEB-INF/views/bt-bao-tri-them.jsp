...
<body>
	<div class="container">
		<div class="title-1">
			<h3>
				<b>NHẬP THÔNG TIN BẢO TRÌ</b>
			</h3>
		</div>
		<div class="title-71">
			<form:form method="post" id="form" modelAttribute="formThem"
				action="${pageContext.request.contextPath}/themlanbaotri">
				<!-- 				 1 -->
					...
					<div class='col-sm-10'>
						<div class='form-group'>
							<label for="user_title">Mã lần xuất thiết bị</label> <input
								...
								value="${maXuatThemLSBT.maXuat }" size="30" readonly="readonly"
								type="text" />
						</div>
					</div>
				</div>
					...
					<div class='col-sm-8'>
						<div class='form-group'>
							<label for="user_title">Tên thiết bị</label> <input
								...
								value="${maXuatThemLSBT.tbChiTietNhapXuat.tenThietBi}" size="30"
					...
					<div class='col-sm-2'>
						<div class='form-group'>
							<label for="user_title">Số lượng</label> <input
								class="form-control" id="user_title" name=""
								value="${maXuatThemLSBT.soLuongXuat}" size="30"
								readonly="readonly" type="text" />
						</div>
					</div>
				</div>
					...
					<div class='col-sm-4'>
						<div class='form-group'>
							<label for="user_firstname">Ngày bảo trì</label> <input
								...
								name="ngayBaoTri" required="true" size="30" />
						</div>
					</div>
					<div class='col-sm-6'>
						<div class='form-group'>
					...
					<div class='col-sm-6'>
						<div class='form-group'>
							<label for="user_title">Chi phí (VNĐ)</label> <input
								...
								name="chiPhi" required="true" size="30" type="text" />
						</div>
					</div>
				</div>
